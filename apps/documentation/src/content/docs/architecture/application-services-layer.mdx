...
│   │   ├── create-your-entity.validator.ts
│   │   └── index.ts
│   ├── update-status/
...
│   │   ├── get-your-entity.handler.ts
│   │   └── index.ts
│   ├── list-your-entities/
│   │   ├── list-your-entities.query.ts
│   │   ├── list-your-entities.handler.ts
│   │   └── index.ts
│   └── get-entity-stats/
│
...
│   └── your-entity-created.handler.ts
│
...
```
services/
  - your-entity.service.ts  ← All operations in one class
```
...
- ✅ Easy to find code
- ✅ Can be moved to separate package
...
```typescript
// ✅ Good - Return DTO, not domain entity
...
```typescript
// ✅ Good - Events published by application layer
