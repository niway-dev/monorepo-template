...
│   │   │   ├── use-cases/
│   │   │   │   ├── create-your-entity/
│   │   │   │   │   ├── create-your-entity.command.ts
│   │   │   │   │   ├── create-your-entity.handler.ts
│   │   │   │   │   └── index.ts
│   │   │   │   ├── update-status/
...
│   │   │   │   └── list-your-entities/
│   │   │   ├── queries/
│   │   │   │   ├── get-your-entity.query.ts
│   │   │   │   └── get-entity-list.query.ts
│   │   │   ├── dto/
│   │   │   │   ├── create-your-entity.dto.ts
│   │   │   │   └── your-entity-response.dto.ts
│   │   │   └── index.ts
│   │   │
│   │   ├── infrastructure/               # Infrastructure layer
│   │   │   ├── persistence/
│   │   │   │   ├── repositories/
│   │   │   │   │   ├── your-entity.repository.drizzle.ts
...
│   │   │   └── index.ts
│   │   │
│   │   ├── package.json                  # Context-specific dependencies
│   │   └── tsconfig.json
│   │
...
│   │   ├── application/
│   │   │   ├── queries/
│   │   │   │   ├── get-success-rate.query.ts
│   │   │   │   ├── get-time-to-complete.query.ts
│   │   │   │   └── get-status-distribution.query.ts
│   │   │   └── index.ts
│   │   ├── infrastructure/
│   │   │   └── persistence/
│   │   │       └── repositories/
...
│   │   ├── your-context-api/             # Public API for Your context
│   │   │   ├── dto/
│   │   │   │   ├── your-entity.dto.ts
│   │   │   │   └── your-entity-summary.dto.ts
│   │   │   └── index.ts
│   │   ├── analytics-api/                # Public API for Analytics context
│   │   │   ├── dto/
│   │   │   └── index.ts
│   │   └── package.json
│   │
...
// packages/analytics/package.json
{
  ...
  "dependencies": {
    "@monorepo-template/shared-kernel": "workspace:*",
    "@monorepo-template/integration": "workspace:*",  // ← Uses context API
    "zod": "catalog:"
  }
}
```
...
// Your Context CANNOT directly use Analytics ❌
...
```typescript
// Analytics using Your Context's public API ✅
import type { YourEntityDTO } from "@monorepo-template/integration/your-context-api";

// Billing subscribing to Your Context events ✅
import type { YourEntityCreatedEvent } from "@monorepo-template/integration/your-context-api/events";
```

---

## 🚀 Real-World Example: Multiple Contexts
...
│                │  │                 │  │                │
│ • Entities     │  │ • Metrics       │  │ • Subscriptions│
│ • Comments     │  │ • Reports       │  │ • Payments     │
│ • Workflows    │  │ • Dashboards    │  │ • Usage        │
└────────┬───────┘  └────────┬────────┘  └────────┬───────┘
         │                   │                     │
         │    publishes      │      listens        │
         │    events         │      to events      │
...
```bash
✅ Good: @monorepo-template/your-context (single responsibility)
❌ Bad: @monorepo-template/your-context-analytics-billing (mixed concerns)
```

### 2. Use Explicit Boundaries

```typescript
// ✅ Clear boundary - context exports only domain
export * from "./domain";
export * from "./application";

// ❌ Unclear - exporting everything
export * from "./domain";
...
```
packages/domain/  ← All business logic here
...
packages/domain/  ← Rename to your-context later
packages/database/
```
