...
```
packages/db/src/queries/your-entity.ts  ← Direct query functions
  └─ findPaginatedYourEntities()       ← Called directly from routes
...
packages/domain/src/repositories/
  └─ your-entity.repository.ts         ← Interface (contract)

packages/database/src/repositories/
  └─ your-entity.repository.drizzle.ts ← Implementation

packages/database/src/mappers/
  └─ your-entity.mapper.ts             ← DB ↔ Domain conversion

apps/server/src/routes/
  └─ your-entities.ts                  ← Uses repository interface
```
...
**Location:** `apps/documentation/src/content/docs/architecture/repository-pattern.mdx`
...
- ❌ `packages/db/src/queries/your-entity.ts` - Deprecated query functions
...
- [Repository Pattern Guide](/architecture/repository-pattern) - Full implementation guide
- [Domain-Driven Design](/domain-architecture-patterns) - DDD principles
- [Authentication Architecture](/authentication/overview) - Similar clean architecture
...
- See: [Repository Pattern Guide](/architecture/repository-pattern)
