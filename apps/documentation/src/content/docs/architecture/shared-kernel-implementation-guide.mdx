...
- Files to move identified (see [Shared Kernel & Bounded Contexts](/architecture/shared-kernel-and-bounded-contexts))
- All tests passing
...
packages/domain/
  src/
    constants/
      ...
      entity-status.ts         # ← Keep
      comment-type.ts          # ← Keep
    types/
...
packages/domain/
  src/
    constants/
      entity-status.ts         # ← Stays
      comment-type.ts          # ← Stays
      priority-level.ts        # ← Stays
```
...
- [Shared Kernel & Bounded Contexts](/architecture/shared-kernel-and-bounded-contexts) - Conceptual guide
